    ...
    <div className='md:mx-5'>
      ...
      <div className='w-full md:w-1/2 mx-auto lg:mt-[-20]'>
          ...
          <div className='flex flex-wrap border-none justify-center sm:justify-center'>
            <div className=' justify-start lg:mr-20  lg:flex lg:flex-wrap '>
              ...
              <div className='lg:ml-10 md:justify-center '>
                <div className="relative h-10 bg-whtie lg:ml-5  lg:mt-10 md:mx-auto  mx-auto md:mr-10 flex justify-center  mt-20" style={{ width: '200px', border: '2px dashed gray', cursor: 'pointer' }}>
              ...
              <div className='md:justify-center text-center flex md:ml-10'>
                <h2 className='text-3xl font-sans text-start text-bold lg:ml-6 mt-10 mx-auto'>Add your location </h2>
              </div>
            </div>
            <br/>
          </div>
        ...
        <input
          ...
          className='border-b-2 border-gray-500 focus:border-gray-500 outline-none text-left p-5 lg:w-full w-1/2 text-2xl lg:ml-10 font-sans'
        />
        <br/><br/>
